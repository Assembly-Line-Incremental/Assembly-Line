...
export function FeatureCard({ icon: Icon, title, description, color }: FeatureCardProps) {
	...
	return (
		<Card
			...
			className="group relative overflow-hidden border-white/6 bg-white/2 py-0 shadow-none backdrop-blur-md transition-all duration-500 hover:border-white/12 hover:bg-white/4"
		>
